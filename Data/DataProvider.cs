...
namespace GIBS.Modules.GIBSMLSImageCleaner.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "GIBS.Modules.GIBSMLSImageCleaner.Data.SqlDataprovider,GIBSMLSImageCleaner";
        ...
        public abstract IDataReader GetListingNumbers();
